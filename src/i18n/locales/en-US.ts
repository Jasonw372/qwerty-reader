const enUS = {
  ...
  articleManager: {
    ...
    tabCreate: "New Article",
    delete: "Delete",
    chooseFile: "Choose File",
    replaceFile: "Replace File",
    fileImportTitle: "Import from .txt",
    ...
    formNoticeTitle: "One more check",
    errorEnglishOnly:
      "This article includes non-English characters. Remove Chinese, emoji, or other special characters before submitting.",
    restorePresets: "Restore Presets",
    restorePresetsHint: "Show all hidden preset articles",
    localLibrary: "Local Articles",
    ...
    searchPublicPlaceholder: "Search public articles by title or source",
